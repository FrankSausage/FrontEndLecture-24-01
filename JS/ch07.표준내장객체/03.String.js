/*
    ...
    2. Web 표준 : UTF-8
        - 초성 + 중성 + 종성 각 1 byte씩, 3 byte 조합형

    ASCII code = 1 byte로 구성
        - 영문자, 숫자, 특수기호 etc...
...
console.log(myDateTime());                  // 2024-00-08 13:57:38
console.log(myDateTime().substring(11));    // 13:57:38 두번째 인수를 생략하면 끝까지 출력
...
// Method chain
console.log(space.trim().substring(0,5).toLocaleUpperCase()); 


// 문자열 변환
const sample = 'A quick brown fox jumps over the lazy dog.';
console.log(sample.replace('A', 'a'));
console.log(sample.replace('o', 'O'));          // 앞에 있는 한 개의 문자만 바뀜
